...
## Move and/or rotate
* `curl http://localhost:5000/motor{/left/right} -XPOST` : Keep moving. The arguments left and right specify the speed of your left and right motors, respectively. A positive number means moving forward. The speed should be between 700 and 2000 for going forward and between -700 and -2000 for going backward. 2000 is very fast and dangerous. However, if it is smaller than around 700, the resistance is too high and you will not move. To turn clockwise, you go like 1000 for left and -1000 for right.
